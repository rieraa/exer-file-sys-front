  ...
  <div>
    <div class="FunctionBar">
      <div class="left">
        ...
        >
          <el-button  size="small" class="upload">
            <i class="iconfont icon-yunshangchuan"></i> 文件上传
          </el-button>
        </el-upload>
        <el-button
            v-if="barType == 'file' && $route.params.path.search('search') == -1"
        ...
        >
          <i class="iconfont icon-add"></i> 新建文件
        </el-button
        >
        <el-button
            size="small"
        ...
        <el-button
            size="small"
            class="displayType" @click="changeShowType">
          <i
      ...
      >
        <a @click.prevent="goLastFolder"><<</a>
    ...
    <div class="tableHead" v-if="$store.state.showType == 'table'">
      ...
      <div class="tableItemCreateTime">日期</div>
    </div>
  </div>
</template>
...
.select {
  ...
  border: 1px solid #158BB8 !important;
}
